        ...
        <div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-gray-700">Create conversational experiences with a no-code builder.</p>
            </div>
            <div>
              ...
              <p className="text-gray-700">Build automated messaging and marketing chatbots.</p>
            </div>
          </div>
        </div>
      </div>
