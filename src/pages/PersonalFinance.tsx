...
const PersonalFinance = () => {
  ...
  const mobileContent = (
    <>
      <SEO 
        ...
        description="Discover AI tools that can help you manage your finances more effectively."
        keywords="AI finance, personal finance, financial planning, budget tools, investment AI"
      />
  ...
  return (
    <CategoryLayout
      ...
      gradientClasses="bg-gradient-to-br from-yellow-100 to-amber-200"
      description="Discover AI tools that can help you manage your finances more effectively."
