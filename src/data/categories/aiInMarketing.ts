...
export const aiInMarketingData = {
  ...
  topics: [
    ...
    },
    {
      ...
      description: "AI can streamline campaign building by generating creative concepts, writing copy variations, designing visual assets, and suggesting targeting parameters based on historical performance data. Tools like Persado can optimize messaging for different audience segments, while platforms like Phrasee can generate and test email subject lines that drive higher open rates.",
      links: [
